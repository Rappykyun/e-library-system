...
export default function CoursesIndex({ courses, programs, faculty, students, filters }: PageProps<CoursesIndexProps>) {
    ...
    // Debug: Log the first course to see what data we're receiving
    console.log('First course data:', courses.data[0]);
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Select onValueChange={(value) => setProgramFilter(value === 'all' ? '' : value)} defaultValue={programFilter || 'all'}>
